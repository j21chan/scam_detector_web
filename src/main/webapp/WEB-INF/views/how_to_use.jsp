...
<body>
    ...
    <main role="main" class="container">
		<br>
		<h1 class="mt-5">How to use Scam Detector</h1>
		<hr>
		<p>
			This page describes the scam detector.
		</p>
		<br>
		
		<div align = "center">
			<p>
				You just hit the detect button in the text box above with the sentence you want to detect scam.
			</p>
		</div>
